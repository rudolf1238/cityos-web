...
export type PartialCompany = Pick<ICompany, 'companyId' | 'id' | 'name' | 'logo' | 'line' | 'url'>;

export type CompanyBasic = Pick<ICompany, 'companyId' | 'id' | 'name' | 'logo' | 'line' | 'url'>;
