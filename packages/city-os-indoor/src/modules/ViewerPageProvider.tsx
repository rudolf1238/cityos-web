...
export interface ViewerPageContextValue {
  ...
  setSelectedFloorNumber: Dispatch<SetStateAction<string | null>>;
...
const ViewerPageProvider = ({
  value,
  children,
}: ProviderProps<ViewerPageContextValue>): ReactElement | null => (
  <ViewerPageContext.Provider value={value}>{children}</ViewerPageContext.Provider>
);
