...
import { BuildingEdge } from '../../../api/getBuildingsOnMobile';

import DivIconMarker from '../../map/DivIconMarker';
...
interface BuildingMarkerLayerProps {
  ...
  handleMarkerClick?: (e: React.MouseEvent<HTMLDivElement>, building: BuildingEdge['node']) => void;
          ...
          <Box
            ...
            onClick={(e: React.MouseEvent<HTMLDivElement>) => {
              if (
                ...
                handleMarkerClick(e, buildingEdge.node);
              }
            }}
          >
