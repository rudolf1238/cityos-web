...
import BuildingGroupMarkerLayer, { Cluster } from '../../map/BuildingGroupMarkerLayer';
...
const BuildingMap: VoidFunctionComponent<BuildingMapProps> = (props: BuildingMapProps) => {
  ...
  const handleMarkerClick = React.useCallback(
    (event: React.MouseEvent<HTMLDivElement, MouseEvent>, building: BuildingEdge['node']): void => {
      void to(
