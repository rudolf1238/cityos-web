...
export interface BuildingCardDesktopProps {
...
const BuildingCardDesktop: VoidFunctionComponent<BuildingCardDesktopProps> = (
  props: BuildingCardDesktopProps,
) => {
    ...
    <Grid item lg={4} md={4} sm={6} xs={12}>
      <Card className={classes.cardRoot}>
        ...
        >
          ...
          <CardContent
            style={{ flexGrow: 1, width: '100%', maxWidth: '100%', padding: theme.spacing(2, 3) }}
          >
...
export default memo(BuildingCardDesktop);
