...
import { BuildingEdge, Query } from '../libs/type';
import { GET_BUILDINGS, GetBuildingsPayload, GetBuildingsResponse } from '../api/getBuildings';
import useIndoorTranslation from '../hooks/useIndoorTranslation';

import AddBuildingDialog from '../modules/dialog/AddBuildingDialog';
...
const Indoor: VoidFunctionComponent = () => {
  ...
  const BuildingMap = useMemo(
    () =>
      dynamic(() => import('../modules/map/BuildingMap'), {
