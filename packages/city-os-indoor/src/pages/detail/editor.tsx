...
import DeleteFloorplanDialog from '../../modules/deleteBuilding/DeleteFloorplanDialog';
import DeviceSelectSideMenu from '../../modules/custom/DeviceSelectSideMenu';
import EditorPageProvider, { EditorPageContextValue } from '../../modules/EditorPageProvider';
import FileSelector from '../../modules/common/FileSelector';
...
const IndoorDetailEditorPage: VoidFunctionComponent = () => {
  ...
  const handleSaveClick = useCallback(async () => {
    ...
    const currentBuildingType =
      getAttrByKey(building?.attributes || [], 'building_type')?.value || 'office';
  ...
  const EditorMap = useMemo(
    () =>
      dynamic(() => import('../../modules/map/EditorMap'), {
        ssr: false,
      }),
    [],
  );
  ...
  const handleCloseEditFloorplansDialog = useCallback(
    (imageId: string | undefined) => {
      ...
      const floorNum = selectedFloorNumber || '';
