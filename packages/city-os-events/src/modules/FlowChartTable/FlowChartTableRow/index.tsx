...
import { RecognitionType, SensorId } from 'city-os-common/libs/schema';
import {
...
const FlowChartTableRow: VoidFunctionComponent<FlowChartTableRowProps> = ({
  ...
  const classes = useStyles();
  const { t } = useEventsTranslation(['common', 'column', 'events', 'variables']);
  ...
  return (
    <div className={classes.root}>
      <Typography variant="body2" align="right" className={classes.timezone}>
        {`${t('common:Time Zone')}: ${getTimezoneString(
