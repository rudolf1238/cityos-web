...
import type { GetVideoPlayerHeaderFunc } from 'city-os-common/modules/videoPlayer/type';
...
const EventSnapshot: VoidFunctionComponent<EventSnapshotProps> = ({
  ...
  const renderFullVideoHeader: GetVideoPlayerHeaderFunc = useCallback(
    (headerClasses) => (
    ...
    [classes.name, classes.playerHeader, device.name],
  );
