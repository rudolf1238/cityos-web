...
import { CameraEventSortField, RecognitionType, SortOrder } from 'city-os-common/libs/schema';
import { ageGroup } from 'city-os-common/libs/constants';
...
import type { AgeGroup } from 'city-os-common/libs/schema';
import type { Column } from 'city-os-common/modules/NestedTable/NestedTableProvider';
...
import { CarModel, Color } from '../../libs/type';
...
import type { FiltersData } from '../../libs/type';
      ...
      cameraEventHistory?.edges?.map(
        ({
          ...
          return {
            ...
            ageGroup:
              humanFlowAge !== null && humanFlowAge !== undefined && humanFlowAge <= ageGroup.SENIOR
                ? humanFlowAge
                : undefined,
          };
        },
