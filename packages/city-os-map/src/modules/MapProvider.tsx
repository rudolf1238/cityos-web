...
import type { DeviceConnection, IDevice } from 'city-os-common/libs/schema';
...
const MapProvider: FunctionComponent<ProviderProps<MapContextValue>> = ({
  value,
  children,
}: ProviderProps<MapContextValue>) => {
