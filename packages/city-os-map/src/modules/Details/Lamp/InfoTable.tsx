...
import type { Group, IDevice, SensorType } from 'city-os-common/libs/schema';
import type { SensorSubscriptionResult } from 'city-os-common/hooks/useSubscribeSensors';
import type { SingleDeviceResponse } from 'city-os-common/api/getMapDevices';
