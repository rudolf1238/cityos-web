...
import type { LightControl, ManualSchedule, Schedule, Timezone } from 'city-os-common/libs/schema';
...
const ScheduleProvider: FunctionComponent<ProviderProps<ScheduleContextValue>> = ({
  value,
  children,
}: ProviderProps<ScheduleContextValue>) => {
