...
import BaseDeviceSearchField from 'city-os-common/modules/DevicesSearchField';
...
import type { PartialDevice } from '../../../../libs/type';
import type { TempCondition } from './type';
...
interface DeviceSearchFieldProps
  extends Omit<ComponentProps<typeof BaseDeviceSearchField>, 'onChange'> {
        ...
        content={
          <>
            <Typography variant="body1">
              {t(
                'If the selected device does not support the sensor ID with the expression, the system will remove that expression_ Are you sure to change the device?',
              )}
            </Typography>
            <Button
              variant="contained"
