...
export const configFormSet = {
  ...
  [ConfigFormType.DEVICES_TITLE]: [GadgetType.PLACE_USAGE, GadgetType.ENERGY_CONSUMPTION],
  [ConfigFormType.DEVICES_TITLE_LAYOUT]: [GadgetType.TODAY_ENERGY_CONSUMPTION],
} as const;
...
export const gadgetSizeSet = {
  ...
  [GadgetType.CAR_FLOW_PREDICT]: [GadgetSize.SQUARE, GadgetSize.RECTANGLE],
  ...
  [GadgetType.TODAY_ENERGY_CONSUMPTION]: [GadgetSize.SQUARE, GadgetSize.RECTANGLE],
  [GadgetType.ENERGY_CONSUMPTION]: [GadgetSize.DEFAULT],
} as const;

export const defaultColors: (keyof Theme['palette']['gadget'])[] = [
  'notInService',
  'stopCharging',
  'default',
  'available',
...
export const tabAmount = 3;

export const emptyConfig: DashboardConfigJson = {
  gadgets: [],
  layouts: {},
};
