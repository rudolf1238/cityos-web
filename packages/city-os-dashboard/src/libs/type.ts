...
export enum GadgetType {
  ...
  CAR_FLOW = 'CAR_FLOW',
  CAR_FLOW_PREDICT = 'CAR_FLOW_PREDICT',
  CAR_FLOWS = 'CAR_FLOWS',
  ...
  TODAY_ENERGY_CONSUMPTION = 'TODAY_ENERGY_CONSUMPTION',
...
export enum ConfigFormType {
  ...
  DEVICES_TITLE_LAYOUT = 'DEVICES_TITLE_LAYOUT',
}
...
export interface GadgetConfig<ConfigType extends ConfigFormType> {
  ...
  setting: ConfigType extends ConfigFormType.DEVICE_ONLY
    ...
    : ConfigType extends ConfigFormType.DEVICES_TITLE_LAYOUT
    ? {
        title: string;
        deviceIds: string[];
        size: GadgetSize;
