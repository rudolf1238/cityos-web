  ...
  const tGadget = useCallback(
    (type: GadgetType) => {
      const mapping: Record<GadgetType, string> = {
        ...
        [GadgetType.CAR_FLOW_PREDICT]: t('Traffic Flow - Predict'),
        ...
        [GadgetType.TODAY_ENERGY_CONSUMPTION]: t('Today Energy Consumption'),
        [GadgetType.ENERGY_CONSUMPTION]: t('Energy Consumption'),
      };
      return mapping[type];
    },
    [t],
