...
import CarFlowPredictRecDarkImg from '../assets/img/gadget-car-flow-predict-rec-dark.png';
import CarFlowPredictRecImg from '../assets/img/gadget-car-flow-predict-rec.png';
import CarFlowPredictSquDarkImg from '../assets/img/gadget-car-flow-predict-squ-dark.png';
import CarFlowPredictSquImg from '../assets/img/gadget-car-flow-predict-squ.png';
...
import EnergyConsumptionDarkImg from '../assets/img/gadget-energy-consumption-dark.png';
import EnergyConsumptionImg from '../assets/img/gadget-energy-consumption.png';
...
import TodayEnergyConsumptionRecDarkImg from '../assets/img/gadget-today-energy-consumption-rec-dark.png';
import TodayEnergyConsumptionRecImg from '../assets/img/gadget-today-energy-consumption-rec.png';
import TodayEnergyConsumptionSquDarkImg from '../assets/img/gadget-today-energy-consumption-squ-dark.png';
import TodayEnergyConsumptionSquImg from '../assets/img/gadget-today-energy-consumption-squ.png';
import WeatherRecDarkImg from '../assets/img/gadget-weather-rec-dark.png';
import WeatherRecImg from '../assets/img/gadget-weather-rec.png';
import WeatherSquDarkImg from '../assets/img/gadget-weather-squ-dark.png';
import WeatherSquImg from '../assets/img/gadget-weather-squ.png';
...
> = {
  light: {
    ...
    [GadgetType.CAR_FLOW_PREDICT]: {
      [GadgetSize.SQUARE]: CarFlowPredictSquImg,
      [GadgetSize.RECTANGLE]: CarFlowPredictRecImg,
    },
    ...
    [GadgetType.WEATHER]: {
      [GadgetSize.SQUARE]: WeatherSquImg,
      [GadgetSize.RECTANGLE]: WeatherRecImg,
    },
    ...
    [GadgetType.TODAY_ENERGY_CONSUMPTION]: {
      [GadgetSize.SQUARE]: TodayEnergyConsumptionSquImg,
      [GadgetSize.RECTANGLE]: TodayEnergyConsumptionRecImg,
    },
    [GadgetType.ENERGY_CONSUMPTION]: {
      [GadgetSize.DEFAULT]: EnergyConsumptionImg,
    },
  },
  dark: {
    [GadgetType.AQI_IN_DIVISION]: {
    ...
    [GadgetType.CAR_FLOW_PREDICT]: {
      [GadgetSize.SQUARE]: CarFlowPredictSquDarkImg,
      [GadgetSize.RECTANGLE]: CarFlowPredictRecDarkImg,
    },
    [GadgetType.CAR_FLOWS]: {
    ...
    [GadgetType.WEATHER]: {
      [GadgetSize.SQUARE]: WeatherSquDarkImg,
      [GadgetSize.RECTANGLE]: WeatherRecDarkImg,
    },
    [GadgetType.PLACE_USAGE]: {
    ...
    [GadgetType.TODAY_ENERGY_CONSUMPTION]: {
      [GadgetSize.SQUARE]: TodayEnergyConsumptionSquDarkImg,
      [GadgetSize.RECTANGLE]: TodayEnergyConsumptionRecDarkImg,
    },
    [GadgetType.ENERGY_CONSUMPTION]: {
      [GadgetSize.DEFAULT]: EnergyConsumptionDarkImg,
    },
  },
};
