...
import { Gender } from 'city-os-common/libs/schema';
import { ageGroup, minOfDay, minOfHour, msOfDay, msOfWeek } from 'city-os-common/libs/constants';
...
const GenderAgeFlow: VoidFunctionComponent<GenderAgeFlowProps> = ({
  ...
  const {
    ...
    error,
    loading,
  } = useQuery<GadgetForGenderAndAgeResponse, GadgetForGenderAndAgePayload>(
    GADGET_FOR_GENDER_AND_AGE,
    {
      variables: {
        input: {
