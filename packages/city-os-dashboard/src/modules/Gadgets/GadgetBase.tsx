...
import type { ConfigFormType, ConfigSaveType, GadgetConfig } from '../../libs/type';
...
> => {
  ...
  const warningIconLabel = t('common:warning');
    ...
    <Card className={classes.root} elevation={5} {...props}>
      ...
      {isForbidden ? (
        <Alert
          ...
          icon={<WarningRoundedIcon aria-label={warningIconLabel} fontSize="default" />}
          action={
            <Button
              size="small"
