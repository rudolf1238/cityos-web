...
import ProfileAvatar from 'city-os-common/modules/ProfileAvatar';
...
const UserManagement: VoidFunctionComponent = () => {
  ...
  const renderAvatar = useCallback(
    (rowData: RowData) => <ProfileAvatar username={rowData?.name} photoId={rowData?.photo} />,
    [],
  );
  ...
  const columns = useMemo<Array<CustomColumn<RowData>>>(
    ...
    [sortField, sortOrder, renderStatus, renderAvatar, getHandleSort, t],
  );
