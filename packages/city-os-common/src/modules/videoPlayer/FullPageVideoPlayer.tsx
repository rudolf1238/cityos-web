...
import type { CutRange, IDevice, VideoClip } from '../../libs/schema';
import type { GetVideoPlayerHeaderFunc } from './type';
...
interface FullPageVideoPlayerProps {
  ...
  header?: ReactNode | GetVideoPlayerHeaderFunc;
  enableDownload?: boolean;
  defaultCutRange?: CutRange;
...
const FullPageVideoPlayer: VoidFunctionComponent<FullPageVideoPlayerProps> = ({
  ...
  const [cutRange, setCutRange] = useState<CutRange | undefined>(defaultCutRange);
  ...
  }, [name, deviceId, clipList, cutRange, onToggleScreen, dispatch, t]);
              ...
              {enableDownload && (
                <>
                  ...
                  <Button
                    ...
                    color="primary"
                    className={classes.fileButton}
                    onClick={handleDownloadCheckerOnOpen}
                    disabled={isWaiting}
                  >
                    <DownloadIcon />
                  </Button>
