...
import type { DeviceFilter, DeviceInSearch } from '../libs/schema';
          ...
          {devicesOptions.map((device) => (
            ...
            >
              ...
              >
                ...
                <Grid item xs={1} container alignItems="center" className={classes.deviceIcon}>
                  <DeviceIcon type={deviceFilter?.type || DeviceType.UNKNOWN} />
                </Grid>
              </Grid>
            </MenuItem>
          ))}
