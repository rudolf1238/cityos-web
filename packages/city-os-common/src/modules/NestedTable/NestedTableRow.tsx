...
import { useNestedTable } from './NestedTableProvider';
import useCommonTranslation from '../../hooks/useCommonTranslation';
import type { RowData } from './NestedTableProvider';
...
const NestedTableRow = <T extends RowData>({
  ...
  const isSelected = useMemo(
    () => selectedRows.some((item) => item.key === rowData.key),
    [rowData.key, selectedRows],
  );
      ...
      >
        ...
        {columns.map(({ field, textWrap, render }, i) => (
          ...
          >
            ...
            >
              {typeof render === 'function' ? render(rowData) : get(rowData, field || '')}
            </AdvancedCollapse>
          </TableCell>
        ))}
      </TableRow>
