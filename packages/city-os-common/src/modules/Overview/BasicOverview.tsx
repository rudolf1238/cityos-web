...
import type { DeviceType, Sensor, SensorId, SensorType } from '../../libs/schema';
import type { RelatedDeviceResponse } from '../../api/getMapDevices';
...
const useStyles = makeStyles((theme) => {
  ...
  return {
    ...
    sensorItems: {
      ...
      [`${downSm}:nth-of-type(6n), ${downSm}:nth-of-type(6n-1), ${downSm}:nth-of-type(6n+1)`]: {
        backgroundColor: theme.palette.background.evenRow,
      },

      [`${downSm}:nth-of-type(6n-2), ${downSm}:nth-of-type(6n-3), ${downSm}:nth-of-type(6n+4)`]: {
