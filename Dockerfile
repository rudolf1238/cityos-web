...
COPY packages/city-os-esignage/package.json ./packages/city-os-esignage/
COPY packages/city-os-wifi/package.json ./packages/city-os-wifi/
...
RUN source '.env'; \
    ...
    if [ -z "${NEXT_PUBLIC_FEAT_EVENTS}" ]; then rm -rf ./packages/city-os-events/ ./packages/city-os-web/src/pages/ivs-events.ts; fi; \
    ...
    if [ -z "${NEXT_PUBLIC_FEAT_ESIGNAGE}" ]; then rm -rf ./packages/city-os-esignage/ ./packages/city-os-web/src/pages/esignage/; fi; \ 
    if [ -z "${NEXT_PUBLIC_FEAT_WIFI}" ]; then rm -rf ./packages/city-os-wifi/ ./packages/city-os-web/src/pages/wifi/; fi
